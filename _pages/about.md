...
I am currently a **Data Science graduate student and Research Assistant** under the supervision of [Prof. Labate Demetrio](https://www.math.uh.edu/~dlabate/index.html), working on research problems related to machine learning in healthcare. My interests lie at the intersection of data analysis, applied machine learning, and healthcare analytics, with an emphasis on building models that are both effective and responsibly evaluated.

My path into data science has been intentionally multidisciplinary. While pursuing my bachelor’s degree, I spent over [four years in social media management](https://drive.google.com/file/d/1yFfHcmxUl6rf3VtdfVxpHN1tRj5F4H2u/view?usp=drive_link), where I worked closely with user behavior, engagement trends, and performance metrics. Although the role was non-technical at first, it trained me to think analytically and ask data-driven questions: *Why do certain patterns emerge? What drives outcomes?* Wanting to go deeper, I learned programming from scratch and transitioned into software engineering(MERN-Stack Developer), building end-to-end applications and developing a strong foundation in problem-solving and system design.
